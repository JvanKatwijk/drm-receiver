...
LINK          = g++
LFLAGS        = -g -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/lib64 -L/lib64 -lqwt-qt5 -lrt -lsndfile -lsamplerate -lportaudio -lusb-1.0 -lfftw3f -ldl -lfdk-aac -larmadillo /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Xml.so /usr/lib64/libQt5Core.so /usr/lib64/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
